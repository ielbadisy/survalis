...
#' Evaluate metrics from a fitted survival learner
#'
#' @param model A fitted model object (e.g., from fit_aareg)
#' @param metrics Character vector of metrics to compute (default: all)
#' @param times Numeric vector of time points to predict at (must be provided)
#'
#' @return A tibble with columns `metric` and `value`
#' @export
